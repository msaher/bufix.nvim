...
busted.describe("error patterns", function()
    ...
    local cases = {
        ...
        { rule = "ant",  line = "[jikes]  foo.java:3:5:7:9: blah blah", want = {col_start = 5, col_end = 9, line = 3, line_end = 7, filename = "foo.java"}},
        ...
        { rule = "python_tracebacks_and_caml", line = "File \"foobar.ml\", lines 5-8, characters 20-155: blah blah", want = {col_start = 20, col_end = 155, line = 5, line_end = 8, filename = "foobar.ml"}},
        { rule = "python_tracebacks_and_caml", line = "File \"F:\\ocaml\\sorting.ml\", line 65, characters 2-145:\nWarning 26: unused variable equ.", want = {col_start = 2, col_end = 145, line = 65, filename = "F:\\ocaml\\sorting.ml"}},
        ...
        { rule = "comma", line = "\"vvouch.c\", line 19.5: 1506-046 (S) Syntax error.", want = {col_start = 5, line = 19, filename = "vvouch.c"}},
        { rule = "comma", line = "\"foo.c\", line 32 pos 1; (E) syntax error; unexpected symbol: \"lossage\"",  want = {col_start = 1, line = 32, filename = "foo.c"}},
        { rule = "comma", line = "\"foo.adb\", line 2(11): warning: file name does not match ...", want = {col_start = 11, line = 2, filename = "foo.adb", type = "warning"}},
        { rule = "comma", line = "\"src/swapping.c\", line 30.34: 1506-342 (W) \"/*\" detected in comment.", want = {col_start = 34, line = 30, filename = "src/swapping.c"}},
        ...
        { rule = "msft", line = "C:\\tmp\\test.cpp(101,11): error C4101: 'bias0123': unreferenced local variable [C:\\tmp\\project.vcxproj]", want = {col_start = 11, line = 101, filename = "C:\\tmp\\test.cpp"}},
        ...
        { rule = "ftnchek", line = "Nonportable usage near line 31 col 9 file assign.f: mixed default and explicit", want = {col_start = 9, line = 31, filename = "assign.f"}},
        ...
        { rule = "ibm", line = "foo.c(2:0) : informational EDC0804: Function foo is not referenced.", want = {col_start = 0, line = 2, filename = "foo.c"}},
        { rule = "ibm", line = "foo.c(3:8) : warning EDC0833: Implicit return statement encountered.", want = {col_start = 8, line = 3, filename = "foo.c"}},
        { rule = "ibm", line = "foo.c(5:5) : error EDC0350: Syntax error.", want = { col_start = 5, line = 5, filename = "foo.c"}},
        ...
        { rule = "gradle_kotlin", line = "e: file:///src/Test.kt:267:5 foo: bar", want = {col_start = 5, line = 267, filename = "/src/Test.kt"}},
        { rule = "gradle_kotlin", line = "w: file:///src/Test.kt:267:5 foo: bar", want = {col_start = 5, line = 267, filename = "/src/Test.kt", type = "warning"}},
        ...
        { rule = "maven", line = "FooBar.java:[111,53] no interface expected here", want = {col_start = 53, line = 111, filename = "FooBar.java"}},
        { rule = "maven", line = "[ERROR] /Users/cinsk/hello.java:[651,96] ';' expected", want = {col_start = 96, line = 651, filename = "/Users/cinsk/hello.java"}},
        { rule = "maven", line = "[WARNING] /foo/bar/Test.java:[27,43] unchecked conversion", want = {col_start = 43, line = 27, filename = "/foo/bar/Test.java", type = "warning"}},
        ...
        { rule = "gcc_include", line = "                 from /usr/include/c++/3.3/backward/iostream.h:31:0,", want = {col_start = 0, line = 31, filename = "/usr/include/c++/3.3/backward/iostream.h"}},
        ...
        { rule = "gnu", line =  "foo.adb:61:11:  [...] in call to size declared at foo.ads:11", want = {col_start = 11, line = 61, filename = "foo.adb"}},
        ...
        { rule = "gnu", line =  "foo.c:8.23: note: message", want = {col_start = 23, line = 8, filename = "foo.c", type = "info"}},
        { rule = "gnu", line =  "foo.c:8.23: info: message", want = {col_start = 23, line = 8, filename = "foo.c", type = "info"}},
        { rule = "gnu", line =  "foo.c:8:23:information: message", want = {col_start = 23, line = 8, filename = "foo.c", type = "info"}},
        { rule = "gnu", line =  "foo.c:8.23-45: Informational: message", want = {col_start = 23, col_end = 45, line = 8, filename = "foo.c", type = "info"}},
        ...
        { rule = "gnu", line = "foo.c:8-45.3: message", want = {col_start = 3, line = 8, line_end = 45, filename = "foo.c"}},
        ...
        { rule = "gnu", line = "jade:dbcommon.dsl:133:17:E: missing argument for function call", want = {col_start = 17, line = 133, filename = "dbcommon.dsl"}},
        ...
        { rule = "gnu", line = "boost/container/detail/flat_tree.hpp:589:25:   [ skipping 5 instantiation contexts, use -ftemplate-backtrace-limit=0 to disable ]", want = {col_start = 25, line = 589, filename = "boost/container/detail/flat_tree.hpp", type = "info"}},
        ...
        { rule = "lcc", line = "E, file.cc(35,52) Illegal operation on pointers", want = {col_start = 52, line = 35, filename = "file.cc"}},
        { rule = "lcc", line = "W, file.cc(36,52) blah blah", want = {col_start = 52, line = 36, filename = "file.cc", type = "warning"}},
        ...
        { rule = "oracle", line = "Semantic error at line 528, column 5, file erosacqdb.pc:", want = {col_start = 5, line = 528, filename = "erosacqdb.pc"}},
        { rule = "oracle", line = "Error at line 41, column 10 in file /usr/src/sb/ODBI_BHP.hpp", want = {col_start = 10, line = 41, filename = "/usr/src/sb/ODBI_BHP.hpp"}},
        { rule = "oracle", line = "PCC-02150: error at line 49, column 27 in file /usr/src/sb/ODBI_dxfgh.pc", want = {col_start = 27, line = 49, filename = "/usr/src/sb/ODBI_dxfgh.pc"}},
        ...
        { rule = "oracle", line = "PCC-02151: line 21 column 40 file /usr/src/sb/ODBI_BHP.hpp:", want = {col_start = 40, line = 21, filename = "/usr/src/sb/ODBI_BHP.hpp"}},
        ...
        { rule = "rxp", line = "in unnamed entity at line 71 char 8 of file:///home/reto/test/group.xml", want = {col_start = 8, line = 71, filename = "/home/reto/test/group.xml"}},
        { rule = "rxp", line = "in unnamed entity at line 4 char 8 of file:///home/reto/test/group.xml", want = {col_start = 8, line = 4, filename = "/home/reto/test/group.xml"}},
        ...
        { rule = "sun", line = "cf90-113 f90comp: ERROR NSE, File = Hoved.f90, Line = 16, Column = 3", want = {col_start = 3, line = 16, filename = "Hoved.f90"}},

        { rule = "sun_ada", line = "/home3/xdhar/rcds_rc/main.a, line 361, char 6:syntax error: \",\" inserted", want = {col_start = 6, line = 361, filename = "/home3/xdhar/rcds_rc/main.a"}},
