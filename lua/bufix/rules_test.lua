package.loaded["bufix.rules"] = nil
local rules = require("bufix.rules")
...
local function test_patterns()
    ...
    local cases = {
        ...
        { rule = "ant",  line = "[javac] /src/DataBaseTestCase.java:49: warning: finally clause cannot complete normally", want = {line = 49, filename = "/src/DataBaseTestCase.java", type = "W"}},
        ...
        {rule = "ant", line = "[checkstyle] [ERROR] /src/Test.java:38: warning: foo", want = {line = 38, filename = "/src/Test.java", type = "W"}},
        ...
        { rule = "borland", line = "Warning pong.c 68: Call to function 'func' with no prototype",  want = {line = 68, filename = "pong.c", type = "W"}},
        { rule = "borland", line = "Error E2010 ping.c 15: Unable to open include file 'sys/types.h'",  want = {line = 15, filename = "ping.c"}},
        { rule = "borland", line = "Warning W1022 pong.c 68: Call to function 'func' with no prototype",  want = {line = 68, filename = "pong.c", type = "W"}},
        ...
        { rule = "cmake", line = "CMake Warning at cmake/modules/UseUG.cmake:73 (find_package):", want = {line = 73, filename = "cmake/modules/UseUG.cmake", type = "W"}},

        { rule = "cmake_info", line = "  cmake/modules/DuneGridMacros.cmake:19 (include)", want = {line = 19, filename = "cmake/modules/DuneGridMacros.cmake", type = "I"}},
        ...
        { rule = "comma", line = "\"foo.adb\", line 2(11): warning: file name does not match ...", want = {col = 11, line = 2, filename = "foo.adb", type = "W"}},
        { rule = "comma", line = "\"src/swapping.c\", line 30.34: 1506-342 (W) \"/*\" detected in comment.", want = {col = 34, line = 30, filename = "src/swapping.c"}},

        { rule = "msft", line = "keyboard handler.c(537) : warning C4005: 'min' : macro redefinition", want = {line = 537, filename = "keyboard handler.c", type = "W"}},
        ...
        { rule = "edg_1", line = "build/intel/debug/struct.cpp(44): warning #1011: missing return statement at end of", want = {line = 44, filename = "build/intel/debug/struct.cpp", type = "W"}},
        { rule = "edg_1", line = "build/intel/debug/iptr.h(302): remark #981: operands are evaluated in unspecified order", want = {line = 302, filename = "build/intel/debug/iptr.h", type = "I"}},
        ...
        { rule = "ftnchek", line = "Warning near line 10 file arrayclash.f: Module contains no executable", want = {line = 10, filename = "arrayclash.f", type = "W"}},
        ...
        { rule = "iar", line = "\"foo.c\",3  Warning[32]: Error message", want = {line = 3, filename = "foo.c", type = "W"}},
        ...
        { rule = "irix", line = "cc: Info: foo.c, line 27: ...", want = {line = 27, filename = "foo.c", type = "I"}},
        { rule = "irix", line = "cfe: Warning 712: foo.c, line 2: illegal combination of pointer and ...", want = {line = 2, filename = "foo.c", type = "W"}},
        { rule = "irix", line = "cfe: Warning 600: xfe.c: 170: Not in a conditional directive while ...", want = {line = 170, filename = "xfe.c", type = "W"}},
        { rule = "irix", line = "/usr/lib/cmplrs/cc/cfe: Error: foo.c: 1: blah blah", want = {line = 1, filename = "foo.c"}},
        { rule = "irix", line = "/usr/lib/cmplrs/cc/cfe: warning: foo.c: 1: blah blah", want = {line = 1, filename = "foo.c", type = "W"}},
        ...
        { rule = "java",  line = "==1332==    by 0x8008621: main (vtest.c:180)", want = {line = 180, filename = "vtest.c", type = "W"}},

        { rule = "gradle_kotlin", line = "e: file:///src/Test.kt:267:5 foo: bar", want = {col = 5, line = 267, filename = "/src/Test.kt"}},
        { rule = "gradle_kotlin", line = "w: file:///src/Test.kt:267:5 foo: bar", want = {col = 5, line = 267, filename = "/src/Test.kt", type = "W"}},
        ...
        { rule = "maven", line = "[WARNING] /foo/bar/Test.java:[27,43] unchecked conversion", want = {col = 43, line = 27, filename = "/foo/bar/Test.java", type = "W"}},

        { rule = "clang_include", line = "In file included from foo.cpp:2:", want = {line = 2, filename = "foo.cpp", type = "I"}},
        ...
        { rule = "gmake", line = "make: *** [Makefile:20: all] Error 2", want = {line = 20, filename = "Makefile", type = "I"}},
        { rule = "gmake", line = "make[4]: *** [sub/make.mk:19: all] Error 127", want = {line = 19, filename = "sub/make.mk", type = "I"}},
        { rule = "gmake", line = "gmake[4]: *** [sub/make.mk:19: all] Error 2", want = {line = 19, filename = "sub/make.mk", type = "I"}},
        { rule = "gmake", line = "gmake-4.3[4]: *** [make.mk:1119: all] Error 2", want = {line = 1119, filename = "make.mk", type = "I"}},
        { rule = "gmake", line = "Make-4.3: *** [make.INC:1119: dir/all] Error 2", want = {line = 1119, filename = "make.INC", type = "I"}},
        ...
        { rule = "gnu", line =  "../foo.c:8: W: message", want = {line = 8, filename = "../foo.c", type = "W"}},
        { rule = "gnu", line =  "/tmp/foo.c:8:warning message", want = {line = 8, filename = "/tmp/foo.c", type = "W"}},
        { rule = "gnu", line =  "foo/bar.py:8: FutureWarning message", want = {line = 8, filename = "foo/bar.py", type = "W"}},
        { rule = "gnu", line =  "foo.py:8: RuntimeWarning message", want = {line = 8, filename = "foo.py", type = "W"}},
        { rule = "gnu", line =  "foo.c:8:I: message", want = {line = 8, filename = "foo.c", type = "I"}},
        { rule = "gnu", line =  "foo.c:8.23: note: message", want = {col = 23, line = 8, filename = "foo.c", type = "I"}},
        { rule = "gnu", line =  "foo.c:8.23: info: message", want = {col = 23, line = 8, filename = "foo.c", type = "I"}},
        { rule = "gnu", line =  "foo.c:8:23:information: message", want = {col = 23, line = 8, filename = "foo.c", type = "I"}},
        { rule = "gnu", line =  "foo.c:8.23-45: Informational: message", want = {col = 23, col_end = 45, line = 8, filename = "foo.c", type = "I"}},
        ...
        -- { rule = "gnu", line = "{standard input}:27041: Warning: end of file not at end of a line; newline inserted", want = {line = 27041, type = "W"}},
        { rule = "gnu", line = "boost/container/detail/flat_tree.hpp:589:25:   [ skipping 5 instantiation contexts, use -ftemplate-backtrace-limit=0 to disable ]", want = {col = 25, line = 589, filename = "boost/container/detail/flat_tree.hpp", type = "I"}},
        ...
        { rule = "lcc", line = "W, file.cc(36,52) blah blah", want = {col = 52, line = 36, filename = "file.cc", type = "W"}},

        { rule = "makepp", line = "makepp: Scanning `/foo/bar.c'", want = {filename = "/foo/bar.c"}},
        { rule = "makepp", line = "makepp: warning: bla bla `/foo/bar.c' and `/foo/bar.h'", want = {filename = "/foo/bar.c", type = "W"}},
        ...
        { rule = "sun", line = "cc-1020 CC: REMARK File = CUI_App.h, Line = 735", want = {line = 735, filename = "CUI_App.h", type = "I"}},
        { rule = "sun", line = "cc-1070 cc: WARNING File = linkl.c, Line = 38", want = {line = 38, filename = "linkl.c", type = "W"}},
        ...
        { rule = "watcom", line = "..\\src\\ctrl\\lister.c(120): Warning! W201: Unreachable code", want = {line = 120, filename = "..\\src\\ctrl\\lister.c", type = "W"}},
